...
export function getOptionValues<const Options extends Record<string, Option<string, unknown>>, Lang extends LanguageName>(
  options: Options,
...
export class StringOption<Name extends string> extends Option<Name, string> {
  public constructor(name: Name, description: string, typeLabel: string, defaultValue: string, kind: OptionKind = "primary") {
    super({
      name,
      kind,
      optionType: "string",
...
export class EnumOption<Name extends string, const EnumMap extends Record<string, unknown>, EnumKey extends Extract<keyof EnumMap, string> = Extract<keyof EnumMap, string>> extends Option<
  Name,
  EnumKey
> {
  private readonly _values: EnumMap;

  public constructor(name: Name, description: string, values: EnumMap, defaultValue: NoInfer<EnumKey>, kind: OptionKind = "primary") {
    super({
      name,
      kind,
      optionType: "enum",
